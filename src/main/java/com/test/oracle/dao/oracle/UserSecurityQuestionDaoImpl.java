...
public class UserSecurityQuestionDaoImpl extends AbstractDaoImpl<UserSecurityQuestion> implements UserSecurityQuestionDao {
    ...
    protected static final String SELECT_COLUMNS = "ua_name, question1, answer1, question2, answer2, question3, answer3, date_modified, attempted_count1, attempted_count2, attempted_count3";

    protected static final String PK_CONDITION = "ua_name=?";

    private static final String SQL_INSERT = "INSERT INTO User_Security_Questions (ua_name, question1, answer1, question2, answer2, question3, answer3, date_modified, attempted_count1, attempted_count2, attempted_count3) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public void insert( UserSecurityQuestion dto ) throws DaoException {
        ...
        try {
            ...
            if ( dto.getUaName() == null || dto.getUaName().length() == 0 ) {
            ...
            if ( dto.getQuestion1() == null || dto.getQuestion1().length() == 0 ) {
            ...
            if ( dto.getAnswer1() == null || dto.getAnswer1().length() == 0 ) {
            ...
            if ( dto.getQuestion2() == null || dto.getQuestion2().length() == 0 ) {
            ...
            if ( dto.getAnswer2() == null || dto.getAnswer2().length() == 0 ) {
            ...
            if ( dto.getQuestion3() == null || dto.getQuestion3().length() == 0 ) {
            ...
            if ( dto.getAnswer3() == null || dto.getAnswer3().length() == 0 ) {
            ...
            if ( dto.getAttemptedCount1() == null ) {
                stmt.setNull( 9, Types.BIGINT );
            }
            else {
                stmt.setLong( 9, dto.getAttemptedCount1() );
            }

            if ( dto.getAttemptedCount2() == null ) {
                stmt.setNull( 10, Types.BIGINT );
            }
            else {
                stmt.setLong( 10, dto.getAttemptedCount2() );
            }

            if ( dto.getAttemptedCount3() == null ) {
                stmt.setNull( 11, Types.BIGINT );
            }
            else {
                stmt.setLong( 11, dto.getAttemptedCount3() );
            }
    ...
    protected UserSecurityQuestion fetch( ResultSet rs ) throws SQLException {
        ...
        dto.setAttemptedCount1( rs.getLong( 9 ));

        if ( rs.wasNull()) {
            dto.setAttemptedCount1( null );
        }

        dto.setAttemptedCount2( rs.getLong( 10 ));

        if ( rs.wasNull()) {
            dto.setAttemptedCount2( null );
        }

        dto.setAttemptedCount3( rs.getLong( 11 ));

        if ( rs.wasNull()) {
            dto.setAttemptedCount3( null );
        }
